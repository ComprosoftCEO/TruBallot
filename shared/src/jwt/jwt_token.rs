...
use crate::jwt::{audience, Audience, JWTSecret, JWT_EXPIRATION_MIN, JWT_ISSUER};
  ...
  A: Audience,
{
  ...
  pub fn test_has_permission(&self, p: Permission) -> bool {
  ...
  A: Audience,
{
  ...
  pub fn new(user_id: Uuid, name: impl ToString, email: impl ToString, permissions: &[Permission]) -> Self {
    let now = Utc::now();
  ...
  T: Serialize + DeserializeOwned,
{
  ...
  fn from_request(req: &HttpRequest, pl: &mut Payload) -> Self::Future {
    let result: Result<Self, Self::Error> = (|| {
